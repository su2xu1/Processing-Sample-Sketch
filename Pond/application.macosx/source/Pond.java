...
public static float[] bezier( float pts[][], float t ) {
  float[][] curr, next;
  next = pts;
...
public void bezierVertex2( float px, float py ) {
float[] pt = {px, py};
  bp[bcount++] = pt;
  if (bcount > 3) {
...
class Fish  {
  ...
  public void setTail(float strength, float wave) {
  ...
  public float[] calc( float px, float py, float s ) {
  ...
  // METHOD: find angle
  public float angle( float px, float py ) {
    return atan2( (py-y), (px-x) );
  }

  public float angle( Fish p ) {
  ...
  // METHOD: speed change
  public void speedChange( float inc ) {
  ...
  public void angleChange( float inc ) {
    angle += inc;
  }

  // METHOD: set speed limit
  public void setSpeedLimit( float max, float min ) {
    maxSpeed = max;
    minSpeed = min;
  }
  ...
  public void turnTo( float ta, float inc ) {
  ...
  public boolean checkBounds( float turn )
  {
  ...
  public void align( Fish fp, float angleSpeed, float moveSpeed ) {
  ...
  public void cohere( Fish[] flocks, float angleSpeed, float moveSpeed  ) {
  ...
  public void seperate( Fish[] flocks, float angleSpeed, float moveSpeed  ) {
  ...
  public void avoid( Fish[] flocks, float angleSpeed, float moveSpeed ) {
  ...
  public void predator( float px, float py, float alertDistance, float angleSpeed, float moveSpeed ) {
  ...
  public void swarm( float px, float py, float d ) {
  ...
  public void scanFlock( Fish[] flocks, float cohereR, float avoidR )
  {
  ...
  public void scanPrey( Fish[] flocks, float range )
  {
    Fish[] near = new Fish[NUM];
    int nCount = 0;
    Fish[] tooNear = new Fish[NUM];
